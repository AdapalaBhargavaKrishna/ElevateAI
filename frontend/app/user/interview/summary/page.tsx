...
import {
    Award, TrendingUp, Lightbulb, Download, RotateCcw, Home,
...
export default function InterviewSummaryPage() {
    ...
    const fetchSummaryData = async () => {
        ...
        try {
            ...
            setError(error.response?.data?.message || 'Failed to load interview summary');
        } finally {
            setIsLoading(false);
        }
    };
...
Level:          ${summaryData.level.toUpperCase()}
Interview Type: ${summaryData.interviewType}
Difficulty:     ${summaryData.difficulty.toUpperCase()}
Date:           ${new Date(summaryData.completedAt).toLocaleString()}
Questions:      ${summaryData.questionsAnswered}/${summaryData.totalQuestions}

📊 OVERALL PERFORMANCE
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Final Score:    ${(summaryData.finalScore * 10).toFixed(0)}/100
...
Keep practicing and improving! 🚀
        ...
        a.href = url;
        a.download = `interview_report_${summaryData.role}_${new Date().toISOString().split('T')[0]}.txt`;
    ...
    const getScoreBreakdown = () => {
        if (!summaryData) return [];
        const totalScore = summaryData.finalScore * 10;
        const questionsScore = summaryData.questions.reduce((sum, q) => sum + (q.overallScore * 20), 0) / summaryData.questions.length;
        
        return [
            { label: 'Technical Knowledge', score: questionsScore, color: 'bg-blue-500' },
            { label: 'Communication', score: totalScore, color: 'bg-green-500' },
            { label: 'Problem Solving', score: (totalScore + questionsScore) / 2, color: 'bg-purple-500' }
        ];
    };
        ...
        <div className="min-h-screen bg-background">
            <div className="max-w-6xl mx-auto px-4 py-6 space-y-6">
                <PageHeader
                    ...
                    description={`${summaryData.interviewType.charAt(0).toUpperCase() + summaryData.interviewType.slice(1)} interview for ${summaryData.role} (${summaryData.level} level) completed`}
                />
                ...
                >
                    <div className="flex flex-col items-center text-center">
                        ...
                        <Badge className={`mt-3 px-4 py-1 text-sm ${verdictColor}`}>
                            {summaryData.verdict}
                        </Badge>
                    </div>
                </motion.div>
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-foreground">
                                        {summaryData.questionsAnswered}/{summaryData.totalQuestions}
                                    </p>
                                </div>
                        ...
                        <CardContent className="pt-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-foreground capitalize">{summaryData.level}</p>
                                </div>
                                <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center">
                        ...
                        <CardContent className="pt-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-foreground capitalize">{summaryData.difficulty}</p>
                                </div>
                                <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center">
                        ...
                        <CardContent className="pt-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-foreground">
                                        {new Date(summaryData.completedAt).toLocaleDateString()}
                                    </p>
                                </div>
                                <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center">
                        ...
                        {getScoreBreakdown().map((item, idx) => (
                            <div key={idx}>
                                <div className="flex justify-between text-sm mb-1">
                                    ...
                                    <span className="text-foreground font-medium">{Math.round(item.score)}/100</span>
                                </div>
                                            ...
                                            <div className="flex items-center gap-2 flex-wrap mb-2">
                                                ...
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    <span className="text-xs text-muted-foreground">
                                                        {q.overallScore?.toFixed(1) || 'N/A'}/5
                                                    </span>
                                                </div>
                                            </div>
                                ...
                                <div className="ml-9 space-y-3">
                                    ...
                                    <div className="bg-primary/5 rounded-lg p-4 border border-primary/10">
                                        <div className="flex items-center gap-2 mb-2">
                                            ...
                                            <span className="text-xs font-medium text-primary">AI Feedback & Improvement Suggestions</span>
                                        </div>
