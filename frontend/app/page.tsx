      ...
      <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-2 mb-12">
              {coreFeatures.map((cat, idx) => (
                <Button
                  key={idx}
                  variant={activeCategory === idx ? "default" : "secondary"}
                  size="sm"
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={8}
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                {[
                  ...
                  <Tooltip key={i}>
                    <TooltipTrigger asChild>
                      <div className="text-center p-4 rounded-xl bg-primary/5 border border-primary/10 cursor-help">
        ...
        <footer className="border-t border-border/50 py-12 px-6">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between gap-10">
            ...
            <div>
              <h4 className="font-semibold text-foreground text-sm mb-4">Explore</h4>
